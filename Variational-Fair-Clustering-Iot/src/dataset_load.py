...
__datasets = ['Adult', 'Bank', 'Synthetic', 'Synthetic-unequal', 'CensusII', 'Sensor']
...
def read_dataset(name, data_dir, k):
    ...
    if name not in __datasets:
        ...
        print("Columns are ", df.columns, df.iloc[0:3, 9])
        # df = df[:n]
        n = df.shape[0]
