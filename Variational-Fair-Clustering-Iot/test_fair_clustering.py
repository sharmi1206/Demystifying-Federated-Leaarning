...
from data_visualization import plot_clusters_vs_lambda, plot_fairness_vs_clusterE, plot_convergence, plot_balance_vs_clusterE, plot_K_vs_clusterE
import random
import warnings
import pandas as pd
...
#    J = len(V_sum)
    ...
    if plot_option_K_vs_clusterE == True and length_lmbdas > 1:
        ...
        #K_list, E_cluster_set, E_0_cluster_set
...
if __name__ == '__main__':
    ...
    for k in range(MIN_CLUSTER_NO, MAX_CLUSTER_NO):
        parser = argparse.ArgumentParser(description="Clustering with Fairness Constraints")
        parser.add_argument('--seed', type=int, default=None)
        # dataset
        parser.add_argument('-d', '--dataset', type=str, default='Sensor',
                            choices=dataset_names())
        # clustering method
        parser.add_argument('--cluster_option', type=str, default='kmeans')

        # Plot options
        parser.add_argument('--plot_option_clusters_vs_lambda', default=True, type=str2bool,
        ...
        parser.add_argument('--plot_option_K_vs_clusterE', default=False, type=str2bool,
                            help="plot convergence of the fair clustering energy")
